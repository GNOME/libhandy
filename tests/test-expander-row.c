...
static void
test_hdy_expander_row_add_prefix (void)
{
  g_autoptr (HdyExpanderRow) row = NULL;
  GtkWidget *radio;
  ...
  hdy_expander_row_add_prefix (row, radio);
}
      ...
      gchar *argv[])
{
  ...
  g_test_add_func("/Handy/ExpanderRow/add_prefix", test_hdy_expander_row_add_prefix);
