...
static void
test_hdy_view_switcher_policy_type (void)
{
  ...
  g_assert_cmpint (hdy_view_switcher_get_policy_type (view_switcher), ==, HDY_VIEW_SWITCHER_POLICY_TYPE_AUTO);

  hdy_view_switcher_set_policy_type (view_switcher, HDY_VIEW_SWITCHER_POLICY_TYPE_NARROW);
  g_assert_cmpint (hdy_view_switcher_get_policy_type (view_switcher), ==, HDY_VIEW_SWITCHER_POLICY_TYPE_NARROW);

  hdy_view_switcher_set_policy_type (view_switcher, HDY_VIEW_SWITCHER_POLICY_TYPE_WIDE);
  g_assert_cmpint (hdy_view_switcher_get_policy_type (view_switcher), ==, HDY_VIEW_SWITCHER_POLICY_TYPE_WIDE);

  hdy_view_switcher_set_policy_type (view_switcher, HDY_VIEW_SWITCHER_POLICY_TYPE_AUTO);
  g_assert_cmpint (hdy_view_switcher_get_policy_type (view_switcher), ==, HDY_VIEW_SWITCHER_POLICY_TYPE_AUTO);
}
      ...
      gchar *argv[])
{
  ...
  g_test_add_func("/Handy/ViewSwitcher/policy_type", test_hdy_view_switcher_policy_type);
