...
gint          hdy_paginator_get_n_pages (HdyPaginator *self);
...
gint          hdy_paginator_get_indicator_spacing (HdyPaginator *self);
...
gint          hdy_paginator_get_spacing (HdyPaginator *self);
