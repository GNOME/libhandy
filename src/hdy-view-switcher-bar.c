                                    ...
                                    GParamSpec *pspec)
{
  ...
  case PROP_POLICY_TYPE:
    g_value_set_enum (value, hdy_view_switcher_bar_get_policy_type (self));
    break;
  case PROP_ICON_SIZE:
                                    ...
                                    GParamSpec   *pspec)
{
  ...
  switch (prop_id) {
  case PROP_POLICY_TYPE:
    hdy_view_switcher_bar_set_policy_type (self, g_value_get_enum (value));
    break;
  case PROP_ICON_SIZE:
...
hdy_view_switcher_bar_class_init (HdyViewSwitcherBarClass *klass)
{
  ...
  /**
   * HdyViewSwitcherBar:policy-type:
   *
   * The policy the #HdyViewSwitcher should use to determine which mode to use.
   *
   * Since: 0.0.10
   */
  props[PROP_POLICY_TYPE] =
    g_param_spec_enum ("policy-type",
                       ...
                       HDY_TYPE_VIEW_SWITCHER_POLICY_TYPE, HDY_VIEW_SWITCHER_POLICY_TYPE_NARROW,
...
hdy_view_switcher_bar_init (HdyViewSwitcherBar *self)
{
  ...
  /* This must be initialized before the template the embedded view switcher can
   * pick up the correct default value.
   */
  priv->policy_type = HDY_VIEW_SWITCHER_POLICY_TYPE_NARROW;
...
/**
 * hdy_view_switcher_bar_get_policy_type:
...
hdy_view_switcher_bar_get_policy_type (HdyViewSwitcherBar *self)
{
  HdyViewSwitcherBarPrivate *priv;

  g_return_val_if_fail (HDY_IS_VIEW_SWITCHER_BAR (self), HDY_VIEW_SWITCHER_POLICY_TYPE_NARROW);
...
/**
 * hdy_view_switcher_bar_set_policy_type:
 * @self: a #HdyViewSwitcherBar
 ...
 */
void
hdy_view_switcher_bar_set_policy_type (HdyViewSwitcherBar        *self,
                                       HdyViewSwitcherPolicyType  policy_type)
{
  HdyViewSwitcherBarPrivate *priv;
