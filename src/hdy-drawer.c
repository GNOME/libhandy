...
/**
 * HdyDrawerPosition
 * @HDY_DRAWER_POSITION_START: The drawer is at the left side and opens rightwards. If a language with right-to-left text direction is used, this is reversed.
 * @HDY_DRAWER_POSITION_END: The drawer is at the right side and opens leftwards. If a language with right-to-left text direction is used, this is reversed.
