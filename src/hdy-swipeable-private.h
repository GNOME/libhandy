...
void hdy_swipeable_emit_switch_child (HdySwipeable *self,
                                      guint         index,
                                      gint64        duration);
void hdy_swipeable_emit_begin_swipe  (HdySwipeable *self);
void hdy_swipeable_emit_update_swipe (HdySwipeable *self,
                                      gdouble       value);
void hdy_swipeable_emit_end_swipe    (HdySwipeable *self,
                                      gint64        duration,
                                      gdouble       to);
