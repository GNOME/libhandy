...
HdyViewSwitcherPolicyType hdy_view_switcher_bar_get_policy_type (HdyViewSwitcherBar *self);
void                      hdy_view_switcher_bar_set_policy_type (HdyViewSwitcherBar        *self,
