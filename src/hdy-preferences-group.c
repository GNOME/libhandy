 ...
 *
 * To presents the role of the preferences it gathers clearly, a group can have
 * both a title and a description. The title will be used by
 * #HdyPreferencesWindow to let the user look for a preference.
 *
 * Since: 0.0.10
 */
 ...
 * @self: a #HdyPreferencesGroup
 *
 * Gets the description of @self, or %NULL.
 *
 * Returns: (transfer none) (nullable): the description of @self, or %NULL.
 *
 * Since: 0.0.10
 */
const gchar *
