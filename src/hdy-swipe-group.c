 ...
 * that implement #HdySwipeable interface, such as #HdyPaginator, so that
 * swiping one of them also animates all the other widgets in the group.
 *
 * This can be useful for syncing widgets between window's titlebar and
 * content area.
 *
 ...
 * \<swipeable\> elements with ”name” attribute specifying the id of the widgets.
 *
 * |[
