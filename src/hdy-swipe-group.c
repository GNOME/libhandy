                           ...
                           GError              **error)
{
  ...
  if (strcmp (element_name, "swipeable") == 0)
    {
      const gchar *name;
      ItemData *item_data;

      if (!_gtk_builder_check_parent (data->builder, context, "swipeables", error))
        return;
  ...
  else if (strcmp (element_name, "swipeables") == 0)
    {
                                            ...
                                            gpointer      *parser_data)
{
  ...
  if (strcmp (tagname, "swipeables") == 0)
    {
