...
gboolean hdy_action_row_get_wrap_title (HdyActionRow *self);
void hdy_action_row_set_wrap_title (HdyActionRow *self,
                                    gboolean wrap);

gboolean hdy_action_row_get_wrap_subtitle (HdyActionRow *self);
void hdy_action_row_set_wrap_subtitle (HdyActionRow *self,
                                       gboolean wrap);
