                   ...
                   int            *natural_baseline)
{
  ...
  if (orientation == GTK_ORIENTATION_HORIZONTAL) {
    ...
    /* FIXME Get child height. */
    gint child_height = get_child_size (HDY_CLAMP (widget), for_size, NULL, NULL, NULL, NULL);
    ...
    gint child_width = get_child_size (HDY_CLAMP (widget), for_size, NULL, NULL, NULL, NULL);
                         ...
                         GtkAllocation *allocation)
{
  ...
  gint clamped_size, child_clamped_size;
  ...
  if (self->orientation == GTK_ORIENTATION_HORIZONTAL) {
    ...
    clamped_size = allocation->height;
