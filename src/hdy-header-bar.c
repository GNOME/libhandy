                        ...
                        gint           *natural_baseline)
{
  ...
  g_message ("border %d %d %d %d", border.top, border.bottom, border.left, border.right);
  g_message ("margin %d %d %d %d", margin.top, margin.bottom, margin.left, margin.right);
  g_message ("padding %d %d %d %d", padding.top, padding.bottom, padding.left, padding.right);
