 ...
 * @self: a #HdySwipeable
 * @duration: Snap-back animation duration in milliseconds
 * @to: The progress value to animate to * @index:
 *
 * This function is called by #HdySwipeTracker as soon as the gesture has
 * stopped. The widget must animate the progress from the current value to @to
 * value with easeOutCubic interpolation over the next @duration milliseconds.
 *
