 ...
 * won't display anything. A depth can be set depth before which the header bars
 * will display all the decorations. See gtk_header_bar_set_decoration_layout().
 *
...
/**
 * hdy_header_group_set_depth:
 * @self: a #HdyHeaderGroup
 * @depth: the depth before which the header bars display all the decorations
 *
 * Sets the depth before which the header bars display all the decorations.
 */
void
hdy_header_group_set_depth (HdyHeaderGroup *self,
                            guint           depth)
{
  HdyHeaderGroupPrivate *priv;
  ...
  g_object_notify_by_pspec (G_OBJECT (self), props[PROP_DEPTH]);
}

/**
 * hdy_header_group_get_depth:
 * @self: a #HdyHeaderGroup
 *
 * Gets the depth before which the header bars display all the decorations.
 *
 * Returns:: The depth before which the header bars display all the decorations
 */
guint
hdy_header_group_get_depth (HdyHeaderGroup *self)
{
  HdyHeaderGroupPrivate *priv;
                               ...
                               GParamSpec *pspec)
{
  ...
  switch (prop_id) {
  case PROP_DEPTH:
    g_value_set_uint (value, hdy_header_group_get_depth (self));
    break;
  default:
                               ...
                               GParamSpec   *pspec)
{
  ...
  switch (prop_id) {
  case PROP_DEPTH:
    hdy_header_group_set_depth (self, g_value_get_uint (value));
    break;
  default:
    G_OBJECT_WARN_INVALID_PROPERTY_ID (object, prop_id, pspec);
  }
...
hdy_header_group_class_init (HdyHeaderGroupClass *klass)
{
  ...
  /**
   * HdyHeaderGroup:depth:
   *
   * The depth before which the header bars display all the decorations.
   */
  props[PROP_DEPTH] =
    g_param_spec_object ("depth",
                         _("Depth"),
                         _("The depth before which the header bars display all the decorations"),
                         GTK_TYPE_HEADER_BAR,
