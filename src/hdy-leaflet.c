...
hdy_leaflet_get_folded (HdyLeaflet *self)
{
  ...
  return hdy_stackable_box_get_folded (priv->box);
}
                             ...
                             gboolean        homogeneous)
{
  ...
  hdy_stackable_box_set_homogeneous (priv->box, folded, orientation, homogeneous);
}
                             ...
                             GtkOrientation  orientation)
{
  ...
  return hdy_stackable_box_get_homogeneous (priv->box, folded, orientation);
}
                      ...
                      HdyNavigationDirection  direction)
{
  ...
  return hdy_stackable_box_navigate (priv->box, direction);
}
                          ...
                          GParamSpec   *pspec)
{
  ...
  case PROP_CAN_SWIPE_FORWARD:
    ...
    break;
  case PROP_ORIENTATION:
    hdy_stackable_box_set_orientation (priv->box, g_value_get_enum (value));
    break;
  default:
    G_OBJECT_WARN_INVALID_PROPERTY_ID (object, prop_id, pspec);
  }
