...
hdy_leaflet_get_fold (HdyLeaflet *self)
{
  ...
  return hdy_stackable_box_get_fold (priv->box);
}
                             ...
                             gboolean        homogeneous)
{
  ...
  hdy_stackable_box_set_homogeneous (priv->box, fold, orientation, homogeneous);
}
                             ...
                             GtkOrientation  orientation)
{
  ...
  return hdy_stackable_box_get_homogeneous (priv->box, fold, orientation);
}
...
hdy_leaflet_get_mode_transition_duration (HdyLeaflet *self)
{
  ...
  return hdy_stackable_box_get_mode_transition_duration (priv->box);
}
                                          ...
                                          guint       duration)
{
  ...
  hdy_stackable_box_set_mode_transition_duration (priv->box, duration);
}
                                ...
                                GParamSpec   *pspec)
{
  ...
  case CHILD_PROP_ALLOW_VISIBLE:
    g_value_set_boolean (value, hdy_stackable_box_get_child_allow_visible (priv->box, widget));
    break;
                                ...
                                GParamSpec   *pspec)
{
  ...
  case CHILD_PROP_ALLOW_VISIBLE:
    hdy_stackable_box_set_child_allow_visible (priv->box, widget, g_value_get_boolean (value));
    gtk_container_child_notify_by_pspec (container, widget, pspec);
    break;
...
static void
notify_fold_cb (HdyLeaflet *self)
{
  g_object_notify_by_pspec (G_OBJECT (self), props[PROP_FOLD]);
}

static void
notify_folded_cb (HdyLeaflet *self)
{
  g_object_notify_by_pspec (G_OBJECT (self), props[PROP_FOLDED]);
}

static void
notify_hhomogeneous_folded_cb (HdyLeaflet *self)
{
  g_object_notify_by_pspec (G_OBJECT (self), props[PROP_HHOMOGENEOUS_FOLDED]);
}

static void
notify_vhomogeneous_folded_cb (HdyLeaflet *self)
{
  g_object_notify_by_pspec (G_OBJECT (self), props[PROP_VHOMOGENEOUS_FOLDED]);
}

static void
notify_hhomogeneous_unfolded_cb (HdyLeaflet *self)
{
  g_object_notify_by_pspec (G_OBJECT (self), props[PROP_HHOMOGENEOUS_UNFOLDED]);
}

static void
notify_vhomogeneous_unfolded_cb (HdyLeaflet *self)
{
  g_object_notify_by_pspec (G_OBJECT (self), props[PROP_VHOMOGENEOUS_UNFOLDED]);
}

static void
notify_visible_child_cb (HdyLeaflet *self)
{
  g_object_notify_by_pspec (G_OBJECT (self), props[PROP_VISIBLE_CHILD]);
}

static void
notify_visible_child_name_cb (HdyLeaflet *self)
{
  g_object_notify_by_pspec (G_OBJECT (self), props[PROP_VISIBLE_CHILD_NAME]);
}

static void
notify_transition_type_cb (HdyLeaflet *self)
{
  g_object_notify_by_pspec (G_OBJECT (self), props[PROP_TRANSITION_TYPE]);
}

static void
notify_mode_transition_duration_cb (HdyLeaflet *self)
{
  g_object_notify_by_pspec (G_OBJECT (self), props[PROP_MODE_TRANSITION_DURATION]);
}

static void
notify_child_transition_duration_cb (HdyLeaflet *self)
{
  g_object_notify_by_pspec (G_OBJECT (self), props[PROP_CHILD_TRANSITION_DURATION]);
}

static void
notify_child_transition_running_cb (HdyLeaflet *self)
{
  g_object_notify_by_pspec (G_OBJECT (self), props[PROP_CHILD_TRANSITION_RUNNING]);
}

static void
notify_interpolate_size_cb (HdyLeaflet *self)
{
  g_object_notify_by_pspec (G_OBJECT (self), props[PROP_INTERPOLATE_SIZE]);
}

static void
notify_can_swipe_back_cb (HdyLeaflet *self)
{
  g_object_notify_by_pspec (G_OBJECT (self), props[PROP_CAN_SWIPE_BACK]);
}

static void
notify_can_swipe_forward_cb (HdyLeaflet *self)
{
...
hdy_leaflet_init (HdyLeaflet *self)
{
  ...
  g_signal_connect_object (priv->box, "notify::fold", G_CALLBACK (notify_fold_cb), self, G_CONNECT_SWAPPED);
