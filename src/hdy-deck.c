                          ...
                          gboolean        homogeneous)
{
  ...
  hdy_stackable_box_set_homogeneous (priv->box, HDY_FOLD_FOLDED, orientation, homogeneous);
}
                          ...
                          GtkOrientation  orientation)
{
  ...
  return hdy_stackable_box_get_homogeneous (priv->box, HDY_FOLD_FOLDED, orientation);
}
