                                  ...
                                  gboolean     selection_mode)
{
  ...
  if (gtk_style_context_has_class (context, "selection-mode") == selection_mode)
    return;
...
hdy_title_bar_get_selection_mode (HdyTitleBar *self)
{
  ...
  return gtk_style_context_has_class (context, "selection-mode");
}
...
hdy_title_bar_class_init (HdyTitleBarClass *klass)
{
  ...
  /**
   * HdyTitleBar:vhomogeneous_unfolded:
   *
