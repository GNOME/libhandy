 ...
 * @self: The #HdyDialer you want to set relief styles of
 * @relief: The GtkReliefStyle as described above
 *
 * Sets the relief style of the edges of the given #HdyDialer widget.
 ...
 * @self: The #HdyDialer you want the #GtkReliefStyle from.
 *
 * Returns the current relief style of the given #HdyDialer.
 *
