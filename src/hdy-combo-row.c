 ...
 * contains a #GtkScrolled window wich in turn contains a #GtkListBox, both are
 * accessible via their regular nodes.
 *
 * A checkmark of node image and of style class .checkmark in the popover
 * denotes the current item.
 *
 * Since: 0.0.6
 */
...
update (HdyComboRow *self)
{
  ...
  g_message ("UPDAAAAAAAAAAAAAAAAAAAAAAATE");
