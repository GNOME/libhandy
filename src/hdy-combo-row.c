...
G_DEFINE_TYPE_WITH_PRIVATE (HdyComboRow, hdy_combo_row, HDY_TYPE_ROW)
...
static void
hdy_combo_row_activate (HdyRow *row)
{
 ...
 *   @model
 * @create_current_widget_func: (nullable): a function that creates widgets for
 *   items to display as the seleted item, or %NULL in case you also passed
 *   %NULL as @model
