...
hdy_column_get_preferred_width (GtkWidget *widget,
                                ...
                                gint      *natural)
{
  measure (widget, GTK_ORIENTATION_HORIZONTAL, -1, minimum, natural, NULL, NULL);
}
...
{
  measure (widget, GTK_ORIENTATION_VERTICAL, width, minimum, natural, minimum_baseline, natural_baseline);
}
...
hdy_column_get_preferred_height (GtkWidget *widget,
                                 ...
                                 gint      *natural)
{
  measure (widget, GTK_ORIENTATION_VERTICAL, -1, minimum, natural, NULL, NULL);
}
