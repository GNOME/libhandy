...
static void
hdy_swipe_tracker_finalize (GObject *object)
{
  HdySwipeTracker *self = (HdySwipeTracker *)object;
  ...
  G_OBJECT_CLASS (hdy_swipe_tracker_parent_class)->finalize (object);
}
...
hdy_swipe_tracker_class_init (HdySwipeTrackerClass *klass)
{
  ...
  object_class->finalize = hdy_swipe_tracker_finalize;
