                                ...
                                GParamSpec *pspec)
{
  ...
  case PROP_MOUSE_DRAG:
    g_value_set_boolean (value, hdy_swipe_tracker_get_mouse_drag (self));
    break;
                                ...
                                GParamSpec   *pspec)
{
  ...
  case PROP_MOUSE_DRAG:
    hdy_swipe_tracker_set_mouse_drag (self, g_value_get_boolean (value));
    break;
...
/**
 * hdy_swipe_tracker_get_mouse_drag:
 * @self: a #HdySwipeTracker
 *
 ...
 */
gboolean
hdy_swipe_tracker_get_mouse_drag (HdySwipeTracker *self)
{
  g_return_val_if_fail (HDY_IS_SWIPE_TRACKER (self), FALSE);
...
/**
 * hdy_swipe_tracker_set_mouse_drag:
 * @self: a #HdySwipeTracker
 * @mouse_drag: whether to allow mouse dragging
 *
 ...
 */
void
hdy_swipe_tracker_set_mouse_drag (HdySwipeTracker *self,
                                  gboolean         mouse_drag)
{
  g_return_if_fail (HDY_IS_SWIPE_TRACKER (self));
  ...
  if (self->mouse_drag == mouse_drag)
    return;

  self->mouse_drag = mouse_drag;

  if (self->touch_gesture)
    g_object_set (self->touch_gesture, "touch-only", !mouse_drag, NULL);
