 ...
 * and provides ronded corners on all, ensuring they can never be overlapped by
 * the content. This makes it safe to use headerbars in the content area as
 * follows:
 *
 * |[
 ...
 *
 * if the window has a #GtkGLArea, it may bring slight performance regresssion
