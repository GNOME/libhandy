 ...
 *
 * Returns: (transfer none) (allow-none): the label, or %NULL
 *
 * Since: 0.0.10
 **/
const gchar *
 ...
 * @self: a #HdyViewSwitcherButton
 * @h_min_width: (out): the minimum width when horizontal
 * @h_nat_width: (out): the natural width when horizontal
 * @v_min_width: (out): the minimum width when vertical
 * @v_nat_width: (out): the natural width when vertical
 *
