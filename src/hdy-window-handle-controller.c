 ...
 * @See_also: #HdyWindowHandle, #HdyHeaderBar
 * @stability: Private
 *
 * HdyWindowHandleController is an object that makes the widget it is added to
 * draggable, and allows it to handle right click, middle click and double click
 * as expected from a titlebar. Currently it's used to implement these
 * properties in #HdyWindowHandle and #HdyHeaderBar
 *
 * Since: 1.0
 */
            ...
            HdyWindowHandleController *self)
{
  ...
  window = gtk_widget_get_toplevel (self->widget);
 ...
 *
 * Create a new #HdyWindowHandleController for @widget.
 *
