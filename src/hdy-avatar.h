 ...
 *
 * The returned #GdkPixbuf is expected to be square with width and height set to @size.
 * No transformation, other then the circle, will be performed. If the pixbuf is wider or
 * higher it will be cut off.  
 *
