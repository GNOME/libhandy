                                    ...
                                    GladeXmlNode *node)
{
  ...
  if (string) {
    property = glade_widget_get_property (widget, GLADE_TAG_SWIPEGROUP_SWIPEABLES);
    g_assert (property);
                                     ...
                                     GladeXmlNode    *node)
{
  ...
  if (glade_widget_property_get (widget, GLADE_TAG_SWIPEGROUP_SWIPEABLES, &widgets)) {
...
glade_hdy_swipe_group_set_property (GladeWidgetAdaptor *adaptor,
                                    ...
                                    const GValue       *value)
{
  if (!strcmp (property_name, GLADE_TAG_SWIPEGROUP_SWIPEABLES)) {
